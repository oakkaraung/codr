        ...
        <div class="row">
          <div class="card" style={{ width: 300, marginTop: 100, marginLeft: 60, padding: 20, backgroundColor: "rgb(2,64,97,0.5)" }}>
            ...
            <div className="card-body">
              ...
              <Link to="/TemplateOne" className="btn btn-info" onClick={this.componentDidUpdate}>Use Basic Birding</Link>
            </div>
          </div>
          <div class="card" style={{ width: 300, marginTop: 100, marginLeft: 60, padding: 20, backgroundColor: "rgb(2,64,97,0.5)" }}>
          ...
          <div class="card" style={{ width: 300, marginTop: 100, marginLeft: 60, padding: 20, backgroundColor: "rgb(2,64,97,0.5)" }}>
            <img src="https://images.pexels.com/photos/327540/pexels-photo-327540.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500" class="card-img-top" alt="bird in tree"/>
            <div className="card-body">
