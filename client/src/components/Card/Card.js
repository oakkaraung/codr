        ...
        <div class="row">
          <div class="card" style={{ width: 300, marginTop: 100, marginLeft: 60, padding: 20 }}>
            ...
            <div className="card-body">
              ...
              <Link to="/TemplateOne" className="btn btn-primary" onClick={this.componentDidUpdate}>Go to Template One</Link>
            </div>
          </div>
          <div class="card" style={{ width: 300, marginTop: 100, marginLeft: 60, padding: 20 }}>
            <img src="https://images.pexels.com/photos/2346344/pexels-photo-2346344.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" class="card-img-top" alt="bird in tree" />
            <div className="card-body">
              ...
              <Link to="/TemplateOne" className="btn btn-primary" onClick={this.componentDidUpdate}>Go to Template Two</Link>
            </div>
          </div>
          <div class="card" style={{ width: 300, marginTop: 100, marginLeft: 60, padding: 20 }}>
            <img src="https://images.pexels.com/photos/2346344/pexels-photo-2346344.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" class="card-img-top" alt="bird in tree" />
            <div className="card-body">
              ...
              <Link to="/TemplateOne" className="btn btn-primary" onClick={this.componentDidUpdate}>Go to Template Three</Link>
            </div>
          </div>
        </div>
      </div>
